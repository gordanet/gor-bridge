...
import (
	...
	"github.com/gordanet/gor-stratum-bridge/src/gostratum"
	"go.uber.org/zap"
...
type BridgeConfig struct {
	...
	RPCServer       string        `yaml:"gord_address"`
...
func ListenAndServe(cfg BridgeConfig) error {
	...
	ksApi, err := NewGorAPI(cfg.RPCServer, blockWaitTime, logger)
	if err != nil {
		return err
	}
	...
	shareHandler := newShareHandler(ksApi.gord)
